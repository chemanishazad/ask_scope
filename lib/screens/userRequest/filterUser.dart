...
class FilterUser extends ConsumerStatefulWidget {
  final Function(Map<String, dynamic>) onFilterApplied;

  const FilterUser({super.key, required this.onFilterApplied});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _FilterUserState();
}

class _FilterUserState extends ConsumerState<FilterUser> {
